            ...
            <%@page import="java.sql.Connection" %>
                ...
                <body>
                    <table border="1">
                        ...
                        <% String id=request.getParameter("search"); try { Class.forName("com.mysql.jdbc.Driver");
                            Connection
                            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/jdbcdatabase","root","g
                            opi2627"); Statement stmt=con.createStatement(); ResultSet rs=stmt.executeQuery("select *
